  ...
  return (
    <Fragment>
      ...
      >
        ...
        <p>
          El sitio web Efemerides 2.0 (El Sitio) utiliza cookies para
          distinguirle de otros usuarios de nuestra página web. Una cookie es un
          ...
          un Usuario o de su equipo y, dependiendo de la información que
          contengan y de la forma en que utilice su equipo, pueden utilizarse
          para reconocer al Usuario. Si continua navegando por la página, está
          aceptando el uso de cookies. Las cookies que puede utilizar un sitio
          Web son del siguiente tipo:
        </p>
        ...
        <ul>
          ...
          <li>
            Cookies de terceros: son aquellas que se envían al equipo terminal
          ...
          <li>
            Cookies de análisis: son aquéllas que bien tratadas por Efemerides
            2.0 o por terceros, nos permiten cuantificar el número de Usuarios y
        ...
        <p>
          ...
          de servicios con los que hemos contratado algún servicio para el que
        ...
        <ul>
          ...
          <li>
            &quot;Google Analytics&quot;: Herramienta de análisis que nos
            permite recoger datos a efectos estadísticos como: fecha de primera
            visita, número de veces que se ha visitado, fecha de la última
            visita, URL y dominio de la que proviene, explorador utilizado y
            resolución de la pantalla. También están habilitadas las funciones
            para anunciantes de Google Analytics, las cuales incluyen:
            remarketing con Google Analytics, informes de impresiones de la Red
            de Display de Google, informes de datos demográficos y de intereses
            de Google Analytics, servicios integrados que requieren Google
            Analytics para recopilar datos mediante las cookies de publicidad de
            Google y los identificadores anónimos. Para inhabilitar las cookies
            de Google Analytics haga clic aquí:
          ...
          <li>
            ...
            publicidad &quot;Google Adsense&quot;. El Usuario puede inhabilitar
            en cualquier momento el uso de la cookie de Google a través de la
            ...
            (California), CA 94043, USA.) Más información de las cookies de
            Google en:
          ...
          <li>
            ...
            información sobre la política de privacidad y las cookies de
            Addthis:
          ...
          <li>
            &quot;Facebook&quot;: La finalidad de las cookies de Facebook es
            poder compartir contenidos en Facebook y retargetizar los Usuarios
            de nuestro Sitio Web para mostrar publicidad personalizada en
            futuras conexiones.
          </li>
          <li>
          ...
          <li>
            &quot;Google Plus&quot;: La finalidad de las cookies de Google Plus
            es poder compartir contenidos en Google Plus
          </li>
        </ul>

        <p>
          El Usuario puede aceptar o no la instalación de cookies, bloquear o
          eliminar las cookies instaladas en su equipo. En caso que no permita
          la instalación de cookies en su navegador es posible que no pueda
          acceder a alguna de las secciones de nuestro Sitio Web. EN los
          siguientes enlaces encontrará información de como deshabilitar cookies
